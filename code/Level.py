...
from code.Const import C_WHITE, C_GREEN, C_CYAN, WIN_WIDTH, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, \
...
class Level:
    ...
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        if game_mode in [MENU_OPTION[1], MENU_OPTION[2]]:
            ...
            self.entity_list.append(player)
        pygame.time.set_timer(EVENT_ENEMY, SPAWN_TIME) # Enemy spawn Time
