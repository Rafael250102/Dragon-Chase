...
class Score:
    ...
    def show(self):
        ...
        pygame.mixer_music.play(-1)
        self.window.blit(source=self.surf, dest=self.rect)
        self.score_text(65, 'TOP 10 SCORE', C_ORANGE, SCORE_POS['TITLE'])
        self.score_text(30, 'NAME            SCORE                DATE ', C_ORANGE2, SCORE_POS['LABEL'])
        db_proxy = DBProxy('DBScore')
    ...
    def score_text(self, text_size: int, text: str, text_color: tuple, text_center_pos: tuple) -> None:
